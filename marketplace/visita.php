					...
					<div class="header_content d-flex flex-row align-items-center justify-content-start">
						...
						<nav class="main_nav">
							<ul>
								...
								<li class="active"><a href="visita.php">Agende uma Visita</a></li>
							</ul>
						</nav>
				...
				<div class="row">
					<div class="col">
						<div class="home_content d-flex flex-row align-items-end justify-content-start">
							<div class="home_title">Visita</div>
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="contact_info">
						<div class="section_title">Agende a sua Visita</div>
						<div class="section_subtitle">Encontre o seu Lar Perfeito</div>
						<div class="contact_info_text"><p>Pronto para ver o seu próximo imóvel de perto? Preencha o formulário e a nossa equipa de especialistas entrará em contacto para confirmar os detalhes da sua visita. Simplificamos o agendamento para que possa focar-se no que realmente importa: encontrar o seu novo lar.</p></div>
				...
				<div class="col-lg-8">
					<div class="contact_form_container">
						<form action="#" class="contact_form" id="contact_form">
							...
							<div><select class="contact_input contact_select">
                                <option>seleccione o imóvel</option>
                                <?php 
                                $selecionar_imovel = $conexao->prepare("SELECT idimovel, titulo FROM imovel order by idimovel desc");
                                $selecionar_imovel->execute();
                                while($row_imovel = $selecionar_imovel->fetch(PDO::FETCH_ASSOC)){
                                    echo '<option value="'.$row_imovel['idimovel'].'">'.$row_imovel['titulo'].'</option>';
                                }
                                ?>
